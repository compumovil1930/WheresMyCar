...
public class MenuActivityChef extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bLogOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAuth.signOut();
                Intent intent = new Intent(MenuActivityChef.this, MainActivity.class);
        ...
        item_payments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), CanjearCreditos.class);
                startActivity(intent);
            }
        });
